...
function addWord(customID, word) {
    ...
    if (yargs.soundsLike) {
        var pattern = /\s*,\s*/;
        var soundsLikeArray = yargs.soundsLike.split(pattern);
