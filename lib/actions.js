...
var list_customizations = function(params, callback) {
  const speech_to_text = require('./stt.js')(params);
  return new Promise((resolve, reject) => {
    speech_to_text.getCustomizations(params).then((getCustomizationsResponse) => {
...
var delete_customization = function(params, callback) {
  const speech_to_text = require('./stt.js')(params);
  return new Promise((resolve, reject) => {
    speech_to_text.deleteCustomization(params).then((deleteCustomizationResponse) => {
...
var corpus_status = function(params, callback) {
  ...
  return new Promise((resolve, reject) => {
    ...
    speech_to_text.getCorpora(params).then((getCorpusResponse) => {
...
var model_status = function(params, callback) {
  ...
  return new Promise((resolve, reject) => {
    ...
    speech_to_text.getCustomization(params).then((getCustomizationResponse) => {
...
var show_oovs = function(params, callback) {
  const speech_to_text = require('./stt.js')(params);
  return new Promise((resolve, reject) => {
    speech_to_text.getWords(params).then((getWordsResponse) => {
