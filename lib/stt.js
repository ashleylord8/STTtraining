...
module.exports = (credentials) => {
  var speech_to_text = new SpeechToTextV1({username: credentials.speechToText_username, password: credentials.speechToText_password});
  return {
    ...
    addCorpus: (params) => new Promise((resolve, reject) => {
      speech_to_text.addCorpus(params, (error, response, body) => {
        if (error) {
          ...
          resolve({'statusCode': body.statusCode, 'customization_id': params.customization_id});
        }
      });
    }),
    ...
    getCorpora: (params) => new Promise((resolve, reject) => {
      speech_to_text.getCorpora(params, (error, response) => {
        if (error) {
          reject(error);
        } else {
          var status;
          ...
          resolve({'status': status, 'customization_id': params.customization_id});
        }
      });
    }),
    ...
    whenCorporaAnalyzed: (params) => new Promise((resolve, reject) => {
      speech_to_text.whenCorporaAnalyzed(params, (error, response) => {
        if (error) {
          reject(error);
        } else {
    ...
    getWords: (params) => new Promise((resolve, reject) => {
      speech_to_text.getWords(params, (error, response) => {
        if (error) {
          reject(error);
        } else {
          resolve({
    ...
    getCustomization: (params) => new Promise((resolve, reject) => {
      speech_to_text.getCustomization(params, (error, response) => {
        if (error) {
          reject(error);
        } else {
    ...
    whenCustomizationReady: (params) => new Promise((resolve, reject) => {
      speech_to_text.whenCustomizationReady(params, (error, response) => {
        if (error) {
          reject(error);
        } else {
          var status = response.status;
    ...
    getCustomizations: (params) => new Promise((resolve, reject) => {
      speech_to_text.getCustomizations(params, (error, response) => {
        if (error) {
          reject(error);
        } else {
          resolve({
    ...
    deleteCustomization: (params) => new Promise((resolve, reject) => {
      speech_to_text.deleteCustomization(params, (error, response, body) => {
        if (error) {
          ...
          resolve({'status': body.statusCode});
        }
      });
    }),
    ...
    addWord: (params) => new Promise((resolve, reject) => {
      speech_to_text.addWord(params, (error, response, body) => {
        if (error) {
          ...
          resolve({'status': body.statusCode, 'customization_id': params.customization_id});
        }
      });
    }),
